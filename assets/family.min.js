...
/* Family mini 28 Feb 2024 */
function setProperty(e,t,i){e.style[t]=i}function switchTo(e,t){setProperty(e,"display","show"===t?"block":"none")}var toggle=document.querySelector("#toggle"),menu=document.querySelector("#menu");function menuToggle(e){e=e||("none"===menu.style.display?"show":"hide"),switchTo(menu,e)}toggle.addEventListener("click",function(){menuToggle()});var header=document.querySelector("#header"),triggerValue=5,lastOffsetY=window.scrollY,headerHeight=header.clientHeight,isReady=!1;function start(){setHeader("show");var e=document.querySelectorAll("article")||"";e&&loadPrism(e)}function setHeader(e){var t,i="top 200ms ";"show"===e?(t="0px",i+="linear"):(t="-"+headerHeight+"px",i+="ease-in");var n="top:"+t+";transition:"+i;menuToggle("none"),setProperty(header,"cssText",n)}function toggleHeader(){var e=window.scrollY,t=e>lastOffsetY&&e>headerHeight/2,i=e+window.innerHeight<document.body.offsetHeight;Math.abs(lastOffsetY-e)>triggerValue&&(t?setHeader("hide"):i&&setHeader("show")),lastOffsetY=e}"complete"===document.readyState||"loading"!==document.readyState?start():document.addEventListener("DOMContentLoaded",start);var menuSearch=document.querySelector("#menu-search");function loadPrism(e){for(var t of e)if(t.querySelector("pre code")){if(document.querySelector("#prism"))Prism.highlightAllUnder(t);else{var i="asset_uri";function n(e){var t=JSON.parse(e.response);if(0===t.code){var n=t.data[i]+"/prism",r=document.createElement("link"),a=document.createElement("script");Object.assign(a,{src:n+".js",id:"prism"}),Object.assign(r,{rel:"stylesheet",href:n+".css",media:"all"}),document.body.append(a),document.head.append(r)}}callXHR({group:"basic",item:i,url:"/api/v1/get_config"},n);break}}}menuSearch.addEventListener("click",function(){isReady=!1}),window.addEventListener("scroll",function(){isReady?toggleHeader():isReady=!0});var isaEl=document.querySelector(".container");if(isaEl){var e='<div class="ias-spinner more"><span class="animation"></span></div><div class="ias-trigger cur more"><a href="#">加载更多</a></div>';isaEl.insertAdjacentHTML("beforeend",e);var t=new InfiniteAjaxScroll(".container",{item:".item",pagination:".pagination",next:".next",spinner:{element:".ias-spinner",delay:600,show:function(e){switchTo(e,"show")},hide:function(e){switchTo(e,"hide")}},trigger:{element:".ias-trigger",when:function(e){return e>2},show:function(e){switchTo(e,"show")},hide:function(e){switchTo(e,"hide")}},logger:!1});t.on("last",function(){for(var t;t=document.querySelector(".container .more");)t.remove();e='<div class="ias-noneleft more">已到结尾</div>',isaEl.insertAdjacentHTML("beforeend",e)}),t.on("load",function(e){e.nocache=!0,lastOffsetY=window.scrollY}),t.on("appended",function(e){loadPrism(e.items)}),t.on("page",e=>{document.title=e.title;var t=history.state;history.replaceState(t,e.title,e.url)})}function like(e){var t=e.getAttribute("data-nonce"),i=e.getAttribute("data-post-id"),n=e.getAttribute("data-iscomment"),r=document.querySelector(".sl-"+("1"===n?"comment-":"")+"button-"+i),a=r.nextSibling;a.insertAdjacentHTML("beforeend",'<div class="loader">Loading...</div>');var s={like:"Like",unlike:"Unlike"};callXHR({post_id:i,nonce:t,is_comment:n,url:"/api/v1/post_like"},function t(i){var n=JSON.parse(i.responseText),o=n.data;setTimeout(function t(){if(0===n.code){var i=o.icon,l=o.count;r.innerHTML=i+l,"unliked"===o.status?(r.setAttribute("title",s.like),r.classList.remove("liked")):(r.setAttribute("title",s.unlike),r.classList.add("liked"))}a.firstChild.remove(),e.classList.add("sl-button")},50)})}function callXHR(e,t){var i=new XMLHttpRequest,n=e.url;delete e.url,i.open("POST",n,!0),i.setRequestHeader("Content-Type","application/json"),i.setRequestHeader("X-WP-Nonce",_brave.nonce),e=JSON.stringify(e),i.send(e),i.onload=function(){200===this.status&&t(this)}}document.addEventListener("click",function(e){for(var t=e.target;t&&t!==document;t=t.parentNode)if(t.matches(".sl-button")){t.classList.remove("sl-button"),like(t);break}});