...
/**
 * Family mini Nov 13 2025
 * https://www.toptal.com/developers/javascript-minifier
 */
function setProperty(e,t,i){e.style[t]=i}function switchTo(e,t){setProperty(e,"display","show"===t?"block":"none")}var menu=document.querySelector("#menu");function menuToggle(e){e=e||("none"===menu.style.display?"show":"hide"),switchTo(menu,e)}document.querySelector("#toggle").addEventListener("click",function(e){menuToggle()});var header=document.querySelector("#header"),triggerValue=5,lastOffsetY=window.scrollY,headerHeight=header.clientHeight,isReady=!1;function start(){setHeader("show");var e=document.querySelectorAll("article")||"";e&&loadPrism(e)}function setHeader(e){var t,i="top 200ms ";"show"===e?(t="0px",i+="linear"):(t="-"+headerHeight+"px",i+="ease-in");var n="top:"+t+";transition:"+i;menuToggle("none"),setProperty(header,"cssText",n)}function toggleHeader(){var e=window.scrollY,t=e>lastOffsetY&&e>headerHeight/2,i=e+window.innerHeight<document.body.offsetHeight;Math.abs(lastOffsetY-e)>triggerValue&&(t?setHeader("hide"):i&&setHeader("show")),lastOffsetY=e}function loadPrism(e){var t=document.querySelector("#prism");for(var i of e)if(i.querySelector("pre code")){if(t)Prism.highlightAllUnder(i);else{var n="asset_uri";callXHR({group:"basic",item:n,url:"/api/v1/get_config"},a);break}}function a(e){var t=JSON.parse(e.response);if(0===t.code){var i=t.data[n]+"/prism",a=document.createElement("link"),r=document.createElement("script");Object.assign(r,{src:i+".js",id:"prism"}),Object.assign(a,{rel:"stylesheet",href:i+".css",media:"all"}),document.body.append(r),document.head.append(a)}}}"complete"===document.readyState||"loading"!==document.readyState?start():document.addEventListener("DOMContentLoaded",start),document.querySelector("#menu-search").addEventListener("click",function(){isReady=!1}),window.addEventListener("scroll",function(){isReady?toggleHeader():isReady=!0});var isaEl=document.querySelector(".container");if(isaEl){var e='<div class="ias-spinner more"><span class="animation"></span></div><div class="ias-trigger cur more"><a>加载更多</a></div>';isaEl.insertAdjacentHTML("beforeend",e);var t=new InfiniteAjaxScroll(".container",{item:".item",pagination:".pagination",next:".next",spinner:{element:".ias-spinner",delay:600,show:function(e){switchTo(e,"show")},hide:function(e){switchTo(e,"hide")}},trigger:{element:".ias-trigger",when:function(e){return e>2},show:function(e){switchTo(e,"show")},hide:function(e){switchTo(e,"hide")}},logger:!1});t.on("last",function(){document.querySelector(".container .more").remove(),e='<div class="ias-noneleft more">已到结尾</div>',isaEl.insertAdjacentHTML("beforeend",e)}),t.on("load",function(e){e.nocache=!0,lastOffsetY=window.scrollY}),t.on("appended",function(e){loadPrism(e.items)}),t.on("page",function(e){document.title=e.title;var t=history.state;history.replaceState(t,e.title,e.url)})}function like(e){var t=e.getAttribute("data-nonce"),i=e.getAttribute("data-post-id"),n=e.getAttribute("data-iscomment"),a=document.querySelector(".sl-"+("1"===n?"comment-":"")+"button-"+i),r=a.nextSibling;r.insertAdjacentHTML("beforeend",'<div class="loader">Loading...</div>');var s={like:"Like",unlike:"Unlike"};callXHR({post_id:i,nonce:t,is_comment:n,url:"/api/v1/post_like"},function t(i){var n=JSON.parse(i.responseText),o=n.data;setTimeout(function t(){if(0===n.code){var i=o.icon,l=o.count;a.innerHTML=i+l,"unliked"===o.status?(a.setAttribute("title",s.like),a.classList.remove("liked")):(a.setAttribute("title",s.unlike),a.classList.add("liked"))}r.firstChild.remove(),e.classList.add("sl-button")},50)})}function callXHR(e,t){var i=new XMLHttpRequest,n=e.url;delete e.url,i.open("POST",n,!0),i.setRequestHeader("Content-Type","application/json"),i.setRequestHeader("X-WP-Nonce",_brave.nonce),e=JSON.stringify(e),i.send(e),i.onload=function(){200===this.status&&t(this)}}document.addEventListener("click",function(e){for(var t=e.target;t&&t!==document;t=t.parentNode)if(t.matches(".sl-button")){t.classList.remove("sl-button"),like(t);break}});