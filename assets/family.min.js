...
/* Family mini Nov 12 2025 */
function setProperty(e,t,n){e.style[t]=n}function switchTo(e,t){setProperty(e,"display","show"===t?"block":"none")}var toggle=document.querySelector("#toggle"),menu=document.querySelector("#menu");function menuToggle(e){e=e||("none"===menu.style.display?"show":"hide"),switchTo(menu,e)}toggle.addEventListener("click",function(){menuToggle()});var header=document.querySelector("#header"),triggerValue=5,lastOffsetY=window.scrollY,headerHeight=header.clientHeight,isReady=!1;function start(){setHeader("show");var e=document.querySelectorAll("article")||"";e&&loadPrism(e)}function setHeader(e){var t,n="top 200ms ";"show"===e?(t="0px",n+="linear"):(t="-"+headerHeight+"px",n+="ease-in");var i="top:"+t+";transition:"+n;menuToggle("none"),setProperty(header,"cssText",i)}function toggleHeader(){var e=window.scrollY,t=e>lastOffsetY&&e>headerHeight/2,n=e+window.innerHeight<document.body.offsetHeight;Math.abs(lastOffsetY-e)>triggerValue&&(t?setHeader("hide"):n&&setHeader("show")),lastOffsetY=e}"complete"===document.readyState||"loading"!==document.readyState?start():document.addEventListener("DOMContentLoaded",start);var menuSearch=document.querySelector("#menu-search");function loadPrism(e){var t=document.querySelector("#prism");for(var n of e)if(n.querySelector("pre code")){if(t)Prism.highlightAllUnder(n);else{var i="asset_uri";callXHR({group:"basic",item:i,url:"/api/v1/get_config"},a);break}}function a(e){var t=JSON.parse(e.response);if(0===t.code){var n=t.data[i]+"/prism",a=document.createElement("link"),r=document.createElement("script");Object.assign(r,{src:n+".js",id:"prism"}),Object.assign(a,{rel:"stylesheet",href:n+".css",media:"all"}),document.body.append(r),document.head.append(a)}}}menuSearch.addEventListener("click",function(){isReady=!1}),window.addEventListener("scroll",function(){isReady?toggleHeader():isReady=!0});var isaEl=document.querySelector(".container");if(isaEl){var e='<div class="ias-spinner more"><span class="animation"></span></div><div class="ias-trigger cur more"><a>加载更多</a></div>';isaEl.insertAdjacentHTML("beforeend",e);var t=new InfiniteAjaxScroll(".container",{item:".item",pagination:".pagination",next:".next",spinner:{element:".ias-spinner",delay:600,show:function(e){switchTo(e,"show")},hide:function(e){switchTo(e,"hide")}},trigger:{element:".ias-trigger",when:function(e){return e>2},show:function(e){switchTo(e,"show")},hide:function(e){switchTo(e,"hide")}},logger:!1});t.on("last",function(){document.querySelector(".container .more").remove(),e='<div class="ias-noneleft more">已到结尾</div>',isaEl.insertAdjacentHTML("beforeend",e)}),t.on("load",function(e){e.nocache=!0,lastOffsetY=window.scrollY}),t.on("appended",function(e){loadPrism(e.items)}),t.on("page",function(e){document.title=e.title;var t=history.state;history.replaceState(t,e.title,e.url)})}function like(e){var t=e.getAttribute("data-nonce"),n=e.getAttribute("data-post-id"),i=e.getAttribute("data-iscomment"),a=document.querySelector(".sl-"+("1"===i?"comment-":"")+"button-"+n),r=a.nextSibling;r.insertAdjacentHTML("beforeend",'<div class="loader">Loading...</div>');var s={like:"Like",unlike:"Unlike"};callXHR({post_id:n,nonce:t,is_comment:i,url:"/api/v1/post_like"},function t(n){var i=JSON.parse(n.responseText),o=i.data;setTimeout(function t(){if(0===i.code){var n=o.icon,l=o.count;a.innerHTML=n+l,"unliked"===o.status?(a.setAttribute("title",s.like),a.classList.remove("liked")):(a.setAttribute("title",s.unlike),a.classList.add("liked"))}r.firstChild.remove(),e.classList.add("sl-button")},50)})}function callXHR(e,t){var n=new XMLHttpRequest,i=e.url;delete e.url,n.open("POST",i,!0),n.setRequestHeader("Content-Type","application/json"),n.setRequestHeader("X-WP-Nonce",_brave.nonce),e=JSON.stringify(e),n.send(e),n.onload=function(){200===this.status&&t(this)}}document.addEventListener("click",function(e){for(var t=e.target;t&&t!==document;t=t.parentNode)if(t.matches(".sl-button")){t.classList.remove("sl-button"),like(t);break}});