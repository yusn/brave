...
include_once(get_template_directory() . '/plugin/MobileDetect/Cache/Cache.php');
include_once(get_template_directory() . '/plugin/MobileDetect/Cache/CacheException.php');
include_once(get_template_directory() . '/plugin/MobileDetect/Cache/CacheItem.php');
include_once(get_template_directory() . '/plugin/MobileDetect/Exception/MobileDetectException.php');
...
class MobileDetect
{
    ...
    protected static array $tabletDevices = [
        ...
        'SamsungTablet'     => [
            'SM-X700|SM-X706|SM-X706B|SM-X706U|SM-X706N|SM-X800|SM-X806|SM-X806B|SM-X806U|SM-X806N|SM-X900|SM-X906|SM-X906B|SM-X906U|SM-X906N|SM-P613',
